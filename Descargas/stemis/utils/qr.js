...
// Remove header from the base64 data
...
// Output file path
const outputPath = 'output.' + extension; // Replace with your desired file path and extension

// Write the buffer to a file
fs.writeFile(outputPath, bufferData, function(err) {
  if (err) {

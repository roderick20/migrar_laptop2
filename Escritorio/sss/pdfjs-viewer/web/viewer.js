 ...
 */
    ...
    document.addEventListener('keydown', function (event) {
        // Verificar si se ha presionado la combinación de teclas Ctrl+P
        if (event.ctrlKey && (event.key === 'p' || event.key === 'P')) {
            // Evitar que se abra el diálogo de impresión
...
function getViewerConfiguration() {
  return {
    ...
    toolbar: {
      ...
      print: document.getElementById("table11"),
      editorFreeTextButton: document.getElementById("editorFreeText"),
      editorFreeTextParamsToolbar: document.getElementById("editorFreeTextParamsToolbar"),
      editorInkButton: document.getElementById("editorInk"),
      editorInkParamsToolbar: document.getElementById("editorInkParamsToolbar"),
      download: document.getElementById("escape")
    },
    secondaryToolbar: {
      ...
      printButton: document.getElementById("secondarytable11"),
      downloadButton: document.getElementById("secondaryescape"),
